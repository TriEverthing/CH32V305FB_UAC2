...
#define CONFIG_PRODUCT                      "CH32V305GB"
#define CONFIG_BOARD                        "HDMI_DEBUG_TOOLS"
...
#define FIRMWARE_START_ADDR                 0x00004000

#define CONFIG_BOOTUF2_FAMILYID             0x12345678
#define CONFIG_BOOTUF2_FLASHMAX             ( 128*1024 - FIRMWARE_START_ADDR  )  //flash
